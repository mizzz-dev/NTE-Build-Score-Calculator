...
type PropsWithProgress = Props & { progressStatus?: 'idle' | 'loading_engine' | 'processing' };
...
export function ScoreOcrAssistPanel({ status, progressStatus = 'idle', error, rawText, candidate, statKeyOptions, onRawTextChange, onSelectImage, onUpdateCandidate, onApplyCandidate }: PropsWithProgress) {
